...
import getCPUUsage from '@/core/utils/os';
import { trigger } from '@/core/utils/hook';
import parsePrefix from '@/core/utils/parsePrefix';
...
router.get('/System', async (ctx) => {
    ...
    const temp = trigger('ROUTER_SYSTEM_1', [retStatus, retBody]);
